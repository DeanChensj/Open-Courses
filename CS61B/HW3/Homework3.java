...
public class Homework3 {
  ...
  public static void smoosh(int[] ints) {
    ...
    int pointerSlow = 0, pointerFast = 0;
    for(; pointerFast < ints.length; pointerFast++){
      if(ints[pointerFast] != ints[pointerSlow]){
        ints[++pointerSlow] = ints[pointerFast];
      }
    }
    for(pointerSlow = pointerSlow + 1; pointerSlow < ints.length; pointerSlow++){
      ints[pointerSlow] = -1;
    }
  }
