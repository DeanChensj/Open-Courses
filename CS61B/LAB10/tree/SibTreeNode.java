...
class SibTreeNode extends TreeNode {
  ...
  public TreeNode parent() throws InvalidNodeException {
    ...
    if(!isValidNode()) throw new InvalidNodeException("Invalid node in parent().");
    if(this == myTree.root()) return new SibTreeNode();
    return parent;
  }
