  ...
  public Entry remove(Object key) {
    ...
    if (node == null) {
      ...
      if(node.leftChild == null && node.rightChild == null){
        ...
        BinaryTreeNode tmpNode = node.leftChild;
        if(tmpNode == null) tmpNode = node.rightChild;
        if(node != root){
         if(node.parent.leftChild == node)
